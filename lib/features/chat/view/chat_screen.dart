...
import 'package:flutter_ai/features/chat/widgets/chats_list.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    // getIt<ChatBloc>().add(ChatGetMessagesEvent(chatName: CHAT_NAME));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: getIt<ChatBloc>().state.status != Status.success
